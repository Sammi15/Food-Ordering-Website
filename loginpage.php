...
<body>
        ...
        <div class="form_container">
            ...
            <div class="input_forms">
                ...
                <form action="./loginuser.php" method="POST" id="LoginForm">
                    ...
                    <hr style="width: 100%;">
                    <span class="spanLink"><a href="./resetpassword.php"> Forgot Password? </a></span>
                </form>
    ...
    <footer class="footerSection">
        <span>&copy; 2021-<?= $date ; ?> Designed & Developed by <span style="color: whitesmoke;"> BVoc[ASD] </span>, All Rights Reserved</span>
    </footer>
