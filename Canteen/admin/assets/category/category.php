    ...
    <div class="area" id="body1">
        <div class=" main-divi" id="body1">
            <div class=" card_container m-1 row" id="body1">
                <div class="heading1">Food Category :
            ...
            ";
                ...
                <td style='text-align:center; font-weight:bold; border-left:none;' class='cat_hideen'> <a href='enablecategory.php?cn=$row[id]' class='bt1'  title='Enable this Category'>  <i class='fa fa-toggle-off' aria-hidden='true'></i>
                ...
                <td style='text-align:center; font-weight:bold; border-left:none;' class='cat_availed'> <a href='disablecategory.php?cn=$row[id]' class='bt1' title='Disable this Category'>  <i class='fa fa-toggle-on' aria-hidden='true'></i> </a> </td>
                ";
                                } ?>
            ...
            <td style='text-align:center; font-size:x-large;'> <a href= 'deletecategory.php?cn=$row[id]'> <i class='fa fa-trash' aria-hidden='true'></i> </a> </td></tr>
