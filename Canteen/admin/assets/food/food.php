                ...
                <div id="id01" class="modal">
                    ...
                    <form class="modal-content animate" method="post" enctype="multipart/form-data">
                        ...
                        <div class="container">
                            ...
                            <input type="text" name="foodname" class="tblinput" id="foodname t1" placeholder="Enter Food Name" pattern="[a-z A-Z]{1,55}" title="Food name must contain letters..! 55 characters only..!" autocomplete="off" required> <br>
                            ...
                            <input type="tel" name="price" class="tblinput" id="price t1" placeholder="Enter Food Amount" pattern="[0-9]{1,55}" title="Food must have a valid price..!" autocomplete="off" required> <br><br>
                            <center>
