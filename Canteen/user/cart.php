                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" class="form-control itemQty" value="<?= $row['qty'] ?>" min=0; style="width:75px;">
                                            </td>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <a href="./service.php" class="btn btn-success"><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;Continue
                                                Shopping</a>
                                        </td>
