...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-expand-lg  navBar">
        ...
        <span class="txtBox"> <b>Name: </b> <span class="profileDetail" style="text-transform: capitalize;"> <?php echo $_SESSION['username']; ?> </span> </span> 
        <span class="txtBox"> <b>Role: </b> <span class="profileDetail"> <?php echo $_SESSION['usertype']; ?> </span> </span>
        <span class="txtBox"> <b>User ID: </b> <span class="profileDetail"> <?php echo $_SESSION['uid']; ?> </span> </span>
        <span class="txtBox"> <b>E-Mail ID: </b> <span class="profileDetail"> <?php echo $_SESSION['email']; ?> </span> </span>
        <span class="txtBox"> <b>Phone Number: </b> <span class="profileDetail"> <?php echo $_SESSION['phone']; ?> </span> </span>
        <span class="txtBox"> <b>Block: </b> <span class="profileDetail"> <?php echo $_SESSION['block']; ?> </span> </span>
        <span class="txtBox"> <b>Department: </b> <span class="profileDetail"> <?php echo $_SESSION['department']; ?> </span> </span>
        <hr>
