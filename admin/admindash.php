                    ...
                    <div class="services-card p-2">
                        <div class="container">
                            ...
                            <div class="count">
                                ...
                                $completed = " SELECT id FROM orders WHERE order_status='1' ";
                                $query_run = mysqli_query($conn, $completed);
                                $row = mysqli_num_rows($query_run);
                                echo '<h4>Completed : ' . $row . '</h4>';
                                ?>
                    ...
                    <div class="services-card p-2">
                        <div class="container">
                            ...
                            <div class="count">
                                ...
                                $query = " SELECT sum(amount_paid) as tot FROM orders WHERE payment_status='1' ";
                                $query_run = mysqli_query($conn, $query);
                    ...
                    <div class="services-card p-2">
                        <div class="container">
                            ...
                            <div class="count">
                                ...
                                $query = " SELECT id FROM orders WHERE order_date BETWEEN '$startdate' AND '$enddate' ";
                                $query_run = mysqli_query($conn, $query);
                                $row = mysqli_num_rows($query_run);
                                echo '<h4>Total Orders : ' . $row . '</h4>';

                                $completed = " SELECT id FROM orders WHERE order_status='1' AND order_date BETWEEN '$startdate' AND '$enddate' ";
                                $query_run = mysqli_query($conn, $completed);
                                $row = mysqli_num_rows($query_run);
                                echo '<h4>Completed : ' . $row . '</h4>';
                    ...
                    <div class="services-card p-2">
                        <div class="container">
                            ...
                            <div class="count">
                                ...
                                $startdate = date('Y-m-d 00:00:00');
                                $enddate = date('Y-m-d 23:59:59');
                                $query = " SELECT sum(amount_paid) as tot FROM orders WHERE payment_status='1' AND order_date BETWEEN '$startdate' AND '$enddate' ";
                                $query_run = mysqli_query($conn, $query);
                                $data = mysqli_fetch_array($query_run);
                                $total = "$data[tot]";
                                if($total==NULL){
