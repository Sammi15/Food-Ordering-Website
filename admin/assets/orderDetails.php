...
<body>
    ...
    <div class="area" id="body1">
        ...
        <div class=" main-divi" id="body1">
            ...
            <span> <b>Food Items [Quantity]: </b>" . $row['products'] . "</span><br>
...
";
                            ...
                            ?>
                                <span> <b>Transaction Image: </b> <img id="myImg" src='../../user/uploads/<?php print $row["file_name"]; ?>' style="border-radius: 10px;" width="50px" height="50px" /> </span><br>
                            <?php
                            }
    ...
    <hr/>
                ...
                <span><b>Order Status:</b> <span style='color: orangered; font-weight:bolder;'> Pending </span> </span>
        ...
        ";
            ...
            <span> <b>Email ID: </b>" . $row['email'] . "</span><br>
