...
<body>
    ...
    <div class="area" id="body1">
        ...
        <div class=" main-divi" id="body1">
            <div class=" card_container m-1 row" id="body1">
                <div class="heading1">Users :





                    <button onclick="document.getElementById('id01').style.display='block'" class=" btn btn1">Add New User</button>
                </div>
                <div class="error_div">
                    <?php
                    if (isset($_SESSION['user_delete_success'])) {
                    ?>
                        <div class="alert alert-success border border-success alert-dismissible fade show errorDiv successMsgDiv" role="alert">
                            <strong style="display: flex; align-items:center; "><i class="bx bx-check-circle bx-sm"></i></strong> <span class="errorSpan">
                                <?php echo $_SESSION['user_delete_success']; ?>
                            </span>
                            <button type="button" style="display: flex; align-items:center; " class="close closeSuccess" data-dismiss="alert" aria-label="Close">
                    ...
                    <?php
                    if (isset($_SESSION['user_delete_fail'])) {
                    ?>
                        <div class="alert alert-dismissible fade show errorDivDanger" role="alert">
                            <span class="errorSpan" style="display: flex;  align-items:center;"> <strong><i class="bx bx-error-circle bx-sm"></i></strong>
                                <?php echo $_SESSION['user_delete_fail']; ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                <button type="button" style="display: flex; align-items:center; " class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </span>
                        </div>
                    <?php
                        unset($_SESSION['user_delete_fail']);
                    }
                    ?>
                ...
                <div class="tables">
                    ...
                    <?php
                    $sql = "select * from management where usertype='Faculty' order by username";
			...
			<td style='text-align:center; text-transform:capitalize;'>" . $row['username'] . "</td>
			<td style='text-align:center;'>" . $row['email'] . "</td>
			<td style='text-align:center;'>" . $row['phone'] . "</td>
			<td style='text-align:center;'>" . $row['block'] . "</td>
			<td style='text-align:center;'>" . $row['department'] . "</td>
			<td style='text-align:center;'>" . date('d/M/Y ', strtotime($row['timeupdated'])) . date('l', strtotime($row['timeupdated'])) . "</td>
            </a> </td>
            <td style='text-align:center;'> <a href= 'deleteuser.php?rn=$row[id]'> <i class='fa fa-trash' aria-hidden='true'></i> </a> </td>
    ...
    <div class="footerReport">
        <a href="excelReport.php">
            <button class="excelReportBtn">Excel Report</button>
        </a>
    </div>
